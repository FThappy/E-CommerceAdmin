  ...
  return (
    <div className='newBanner'>
      ...
      <form className='newBannerForm'>
        ...
        <div className='newBannerItem'>
          <label>Title</label>
          <input type='text' name='title' placeholder='Panda Bear' onChange={handleChange} />
        </div>
        <div className='newBannerItem'>
          <label>BackGround Color</label>
          <input type='text' name='bg' placeholder='fffff' onChange={handleChange} />
        </div>
        <div className='newBannerItem'>
        ...
        <div className='newBannerItem'>
          <label>Active</label>
          <select className='newBannerSelect' name='active' id='active' onChange={handleChange}>
