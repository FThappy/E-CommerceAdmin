...
export default function UserList() {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: params => {
        return (
          <Grid container justifyContent='left' alignItems='center' fontSize={15}>
            {params?.value}
          </Grid>
        );
      }
      ...
      renderCell: params => {
        return (
          <Grid container justifyContent='center' alignItems='center'>
            ...
            {params.row.active ? (
              <Visibility className='bannerListVisi' onClick={() => handleVisi(params.row?._id, params.row.active)} />
            ) : (
              <VisibilityOff
